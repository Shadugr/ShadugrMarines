...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/wo/populate_product_list(scale)
	listed_products = list(
		...
		list("USCM Patrol Cap", floor(scale * 10), /obj/item/clothing/head/cmcap, VENDOR_ITEM_REGULAR),
		list("USCM Boonie Cap", floor(scale * 10), /obj/item/clothing/head/cmcap/boonie, VENDOR_ITEM_REGULAR),

		list("RADIO HEADSETS", -1, null, null),
		list("First Platoon Headset", floor(scale * 5), /obj/item/device/radio/headset/almayer/marine/solardevils, VENDOR_ITEM_REGULAR),
		...
		list("M10 Helmet Camo Cover", floor(scale * 5), /obj/item/prop/helmetgarb/camocover, VENDOR_ITEM_REGULAR),
