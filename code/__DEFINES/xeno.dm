...
#define XENO_HEALTH_QUEEN 2000 * XENO_UNIVERSAL_HPMULT
#define XENO_HEALTH_IMMORTAL 1500 * XENO_UNIVERSAL_HPMULT
#define XENO_HEALTH_KING 2500 * XENO_UNIVERSAL_HPMULT
