...
#define MARINE_CAN_BUY_M49_AMMO "m49_ammo"
#define MARINE_CAN_BUY_M37_AMMO "m37_ammo"
#define MARINE_CAN_BUY_M39_AMMO "m39_ammo"
#define MARINE_CAN_BUY_M41_AMMO "m41_ammo"
#define MARINE_CAN_BUY_MRE "mre"
#define MARINE_CAN_BUY_ACCESSORY "accessory"
#define MARINE_CAN_BUY_CLOTHING_ACCESSORY "clothing_accessory"
...
#define MARINE_CAN_BUY_ALL list( \
	MARINE_CAN_BUY_UNIFORM = 1, \
	MARINE_CAN_BUY_SHOES = 1, \
	MARINE_CAN_BUY_HELMET = 1, \
	MARINE_CAN_BUY_ARMOR = 1, \
	MARINE_CAN_BUY_PAINT = 1, \
	MARINE_CAN_BUY_GLOVES = 1, \
	MARINE_CAN_BUY_EAR = 1, \
	MARINE_CAN_BUY_BACKPACK = 1, \
	MARINE_CAN_BUY_POUCH = 10, \
	MARINE_CAN_BUY_BELT = 1, \
	MARINE_CAN_BUY_GLASSES = 1, \
	MARINE_CAN_BUY_MASK = 1, \
	MARINE_CAN_BUY_ESSENTIALS = 1, \
	MARINE_CAN_BUY_SECONDARY = 1, \
	MARINE_CAN_BUY_ATTACHMENT = 1, \
	MARINE_CAN_BUY_MRE = 1, \
	MARINE_CAN_BUY_ACCESSORY = 1, \
	MARINE_CAN_BUY_CLOTHING_ACCESSORY = 1, \
	MARINE_CAN_BUY_M49_AMMO = 6, \
	MARINE_CAN_BUY_M37_AMMO = 6, \
	MARINE_CAN_BUY_M39_AMMO = 6, \
	MARINE_CAN_BUY_M41_AMMO = 6, \
